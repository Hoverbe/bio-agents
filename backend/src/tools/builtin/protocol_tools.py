...
class MCPTool(Tool):
    ...
    使用示例:
        # >>> from backend.app.tools.builtin import MCPTool
        # >>>
        # >>> # 方式1: 使用内置演示服务器
    ...
    def _discover_tools(self):
        """发现MCP服务器提供的所有工具"""
        try:
            from backend.src.protocols.mcp.client import MCPClient
            import asyncio
    ...
    def get_expanded_tools(self) -> List['Tool']:  # type: ignore
        ...
        from backend.src.tools.builtin.mcp_wrapper_tool import MCPWrappedTool
